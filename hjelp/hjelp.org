...
- Le <ĺ> subit une métamorphose similaire lors d’un contact avec les voyelles fermées et pré-fermées antérieures <i>, <y>, <ì>, <ĩ> et <ů> et se réalise alors comme un [l̩ʲ].
