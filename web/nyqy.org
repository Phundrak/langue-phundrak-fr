...
** C
   ...
   - {{{nyqy(coj)}}}     ::  (gp)  façon  d’être,  d’exister,  comparatif  qualitatif,
        équatif.     Particule     grammaticale,      graphème     lié,     voir
...
** S
   ...
   :END:
   - {{{nyqy(séwe)}}} ::  (n) porte, voile de  tissu utilisé à l’entrée  des maisons,
        tissu
   - {{{nyqy(sósy)}}} :: (vi) vivre, respirer
   - {{{nyqy(só)}}} ::  façon de faire, manière  de faire, d’agir. Graphème  lié, voir
                       [[#h-6abaae53-a2b8-4cc1-aa03-10c8b4a45b0a]].
   - {{{nyqy(súmusq)}}} :: (n) maison communale
   - {{{nyqy(sy)}}} :: (n) air, vent, vie, souffle
   - {{{nyqy(syjéq)}}} ::  (v) souffler (vent, respiration),  expirer, litt. « pousser
        de l’air ». Voir /sy/ et /jéq/.
...
* Choses à faire [0/2]                                             :noexport:
  :PROPERTIES:
  :CUSTOM_ID: h-66fbd617-f391-47d6-b3ea-06ffe259deee
  :END:
** TODO corriger ~conlang/nyqy-to-phonetics~
   :PROPERTIES:
...
** TODO améliorer l’apparence des termes du dictionnaire en LaTeX
   :PROPERTIES:
