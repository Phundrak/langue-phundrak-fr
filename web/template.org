...
*** Multilinguisme et attitude envers les langues
    ...
    # - As  far as  you can  tell, what  is the  attitude of  the speakers  of this
    #   language toward  their language,  as opposed to  other languages  they may
    #   know? If  possible, give evidence  for your claims  even though it  may be
    #   anecdotal.
...
*** Viabilité
    ...
    :END:
    # - Are children  learning the language  as their  first language? If  so, how
    #   long do they remain monolingual?
    # - What pressures  are there on young  people to (a) learn  another language,
    #   and (b) reject their own language? How strong are these pressures?
...
** Dialectes
   ...
   :END:
   # - Is  there   significant  dialect   variation?  What  kind   of  differences
   #   distinguish the dialects? Give examples.
