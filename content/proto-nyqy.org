...
** Esquisse typologique du Proto-Ñyqy
   ...
   4. {{{nyqy(qy qunoqéop)}}}
      ...
      Je souhaitais boire
   5. {{{nyqy(cé pimi bómygú coqugmúnop zé qy zúmuop)}}}
   ...
   cinquième exemple sous  la forme /cé pim i  bó mygú coq ug mún op  zé qy zúmu
   ...
   aucune différence grammaticale ou autre) : /cé pim:i bó:mygú coq-ug-mún-op zé
   qy zúmu-op/.
...
** Structure d’un mot
   ...
   {{{nyqy(zocséwe)}}},  composé de  {{{nyqy(zoc)}}} et  {{{nyqy(séwe)}}}. On  pourrait parler  de
   « tissu de tête » avec {{{nyqy(zoc pom  séwe)}}}, cependant la fusion des deux mots
   ...
   {{{nyqy(zócu)}}} peut se  décoposer en {{{nyqy(zój sy)}}}, ou « chose  vivante », mais la
...
**** Pronoms personnels
     ...
     | singulier      | {{{nyqy(mi)}}}  |
     | duel           | {{{nyqy(qi)}}}  |
     | triel / paucal | {{{nyqy(né)}}}  |
     | pluriel        | {{{nyqy(ñy)}}}  |
     Notez bien  que l’utilisation  de {{{nyqy(mi)}}}, bien  que probable,  étant sans
     doutes rare.  On ne sait pas  également si {{{nyqy(né)}}} marquait  uniquement le
...
**** Numéraux
     ...
     |   10368   |    4320    |    144     |       60       |    3     |
     Ainsi, 14875 se traduit  par {{{nyqy(gec cosi qimó geñyñy né)}}}.  Il est à noter
     ...
     {{{nyqy(qujm qimó ñocm  gé)}}}, et {{{nyqy(qujmó ñygé ñocm)}}} se  traduira par « 82ème
...
**** Numéraux
     ...
     chats » se traduit par {{{nyqy(néñy cé oz qi)}}}.
     | <c>  |   <c>    | <c>  | <c> |
     | néñy |    cé    |  oz  | qi  |
     | 3×6  | POSS.1sg | chat |  2  |
...
**** Démonstratifs
     ...
     même temps), on a donc {{{nyqy(bóc néñy cé oz qi)}}}.
     |   <c>    | <c>  |   <c>    | <c>  | <c> |
     |   bóc    | néñy |    cé    |  oz  | qi  |
     ...
     utilisé ici dû aux limitations du  Français), on obtient {{{nyqy(bó néñy cé oz
     qi)}}}.
     |   <c>   | <c>  |   <c>    | <c>  | <c> |
     |   bó    | néñy |    cé    |  oz  | qi  |
...
**** Adjectifs
     ...
     Exemple :
     - « je trouve que ce chat est grand »
       | bó      | oz   | goñ   |
       | art.def | chat | grand |

     - « ce chat est (à mon avis) très grand »
       | bó      | goñ   | oz   |
       | art.def | grand | chat |
     Dans la phrase {{{nyqy(bóoz goñ)}}}, le locuteur indique que le chat est grand et
     la phrase peut se traduire par « ce  chat est grand ». En revanche, dans la
     seconde phrase, {{{nyqy(bógoñ oz)}}}, le  locuteur indique que l’indication de la
...
*** Temps
    ...
    s’y référera au non-passé. Par exemple, la phrase {{{nyqy(bómygú pimi coq)}}} peut
...
*** Aspects
    ...
    Exemples :
    - {{{nyqy(qy uñmúnop ñyim bómygú zúmuucop)}}}
...
** B
   ...
   - {{{nyqy(béwoñ)}}} :: {{{defnl}}} Voir /bé/ et /woñ/
     1. (n) quelque chose de puant, de pourris
     2. (n) puanteur, pourriture
     3. (vi) puer, pourrir
     4. (vi) se décomposer
     5. (vt) corrompre
   - {{{nyqy(bijéñ)}}} :: {{{defnl}}} Voir /bomij/ et /wéñ/
   ...
   - {{{nyqy(bónusq)}}} :: {{{def}}}
     1. (n) village
   - {{{nyqy(bópéñ)}}} :: {{{defnl}}} Voir /bópo/ et /wéñ/
     1. (n) journée, partie ensoleillée du jour
   - {{{nyqy(bópo)}}} :: {{{defnl}}} Voir /bó/ et /po/
     1. (n) le Soleil
...
** C
   ...
   - {{{nyqy(cuwéñ)}}} :: {{{defnl}}} Voir /cosu/ et /wéñ/
     1. (adv) tout le temps
   - {{{nyqy(cúqé)}}} :: {{{def}}}
     1. (n) fourmi
...
** É
   ...
   - {{{nyqy(éméz)}}} :: {{{def}}}
     1. (n) mère
   - {{{nyqy(émpé)}}} :: {{{defnl}}} Voir /éméz/ et /épéq/
     1. (n) maternité, paternité
   - {{{nyqy(émpécoj)}}} :: {{{defnl}}} Voir /émpé/ et /coj/
...
** M
   ...
   - {{{nyqy(meqm)}}} :: {{{def}}}
     ...
     3. (vt) enseigner
   - {{{nyqy(mesyq)}}} :: {{{defnl}}} Voir /meqm/ et /syjéq/
   ...
   - {{{nyqy(miqiné)}}} :: {{{defnl}}} Voir /mi/, /qi/, /né/
   ...
   - {{{nyqy(mójmicp)}}} :: {{{defnl}}} Voir /mójpi/ et /micp/
...
** Ñ
   ...
   - {{{nyqy(ñucm)}}} :: {{{def}}}
     1. (n) chute
     2. (vi) tomber, chuter
   - {{{nyqy(ñuné)}}} :: {{{defnl}}} Voir aussi /wéz/
...
** P
   ...
   - {{{nyqy(puqó)}}} :: {{{defnl}}} Voir /pus/ et /qó/
     1. (n) mer, océan
...
** Q
   ...
   - {{{nyqy(qébsin)}}} :: {{{defnl}}} Voir /qéeb/ et /sin/
     1. (n) montagne
     2. (vi) trôner, dominer
   - {{{nyqy(qéeb)}}} :: {{{defnl}}} Voir /qé/ et /meb/
     1. (n) colline
   - {{{nyqy(qéy)}}} :: {{{def}}}
     1. (n) chaleur
     2. (vi) se réchauffer
...
** S
   ...
   - {{{nyqy(syjéq)}}} :: {{{defnl}}} Voir /sy/ et /jéq/
     1. (n) souffle
     2. (n) vent
   ...
   - {{{nyqy(syg)}}} :: {{{def}}}
     1. (n) beauté
   - {{{nyqy(sywéqun)}}} :: {{{defnl}}} Voir /sywéz/ et /qun/
     1. (n) Chaman. Aspirant aux esprits, aux âmes, aux dieux.
   - {{{nyqy(sywéz)}}} :: {{{defnl}}} Voir /sy/ et /wéz/
     1. (n) souffle divin, âme, esprit
   - {{{nyqy(sywézéc)}}} :: {{{defnl}}} Voir /sywéz/ et /éc/
     1. (n) tristesse
...
** W
   ...
   - {{{nyqy(won)}}} :: {{{def}}}
     1. (vt) voler, nager, se déplacer.
        ...
        Exemple : {{{nyqy(yc bó péj won)}}} « Le poisson nage », litt. « le poisson se
   ...
   - {{{nyqy(wócosu)}}} :: {{{defnl}}} Voir /wó/ et /cosu/
...
** Y
   ...
   - {{{nyqy(ycne)}}} :: {{{defnl}}} Voir /ne/ et /yc/
     1. (n) mort
     2. (vi) mourir
   - {{{nyqy(ycéjéz)}}} :: {{{defnl}}} Voir /yc/, /újq/ et /wéz/
...
** Z
   ...
   - {{{nyqy(zoc)}}} :: {{{def}}}
     ...
     3. (n) sommet
   - {{{nyqy(zocséwe)}}} :: {{{defnl}}} Voir /zoc/ et /séwe/
     1. (n) voile ou châle porté autour de la tête. Litt. « tissu de tête »
   - {{{nyqy(zó)}}} :: {{{def}}}
     1. (n) jeu
     2. (vt) jouer
   - {{{nyqy(zócu)}}} :: {{{defnl}}} Voir /sy/ et /zój/
     1. (n) animal
