...
** Nombres
   ...
   deuxième position, et ainsi de suite.  Ainsi, pour représenter le poids d’une
   ...
   nombres  exposés.  Notez  qu’en  dehors   des  unités,  le  zéro  n’a  qu’une
   ...
   nombre s’applique à un nom. Voir [[#h-26b82cb5-1316-46cb-b9c5-279bbded3cc5]].
...
** B
   ...
   - {{{nyqy(bóc)}}} ::
     1. (pron.dem) ceci, ça, démonstratif de proximité
   - {{{nyqy(bú)}}} ::
...
** É
   ...
   - {{{nyqy(émpécoj)}}} :: Voir /émpé/ et /coj/
     1. (adj) maternel, paternel, parental
     2. (adj) protecteur
   - {{{nyqy(épéq)}}} ::
     1. (n) père, papa
   - {{{nyqy(éqcó)}}} ::
...
** W
   ...
   - {{{nyqy(wéz)}}} ::
     ...
     2. (adj) divin (implicitement de divinité suprême), créateur (implicitement
        magique), supérieur
   - {{{nyqy(won)}}} ::
