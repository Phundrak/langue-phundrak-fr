...
#+INCLUDE: headers
#+OPTIONS: auto-id:t
#+UID: https://langue.phundrak.com/hjelp
...
*** Les consonnes
    ...
    - s ::  Ce <s>  est le <s>  standard alvéolaire que  l’on retrouve  dans des
           ...
           que dans  « façade » [fäs̪äd̪] est  dentalisé, contrairement au  <s> du
    ...
    - sh ::  Cette consonne  peut se  retrouver dans des  langues telles  que le
            ...
            « chadenn »  [ʃadeñ].  Il  s’agit   donc  d’une  consonne  fricative
