...
** Allophonie
   ...
   *{{{phon(ɴɛ  pɔm qy)}}},  et  la phrase  <qi  bü pim  mo  coq> se  prononcera
   {{{phon(qɪ bʊ χɪm ʀo ɬoq)}}} au lieu de *{{{phon(qɪ bʊ pɪm mɔ t͡ʃɔq)}}}.
...
** Phonotaxes
   ...
   (§[[#h-19816428-bd33-40a2-a682-acc2d0afe668]]) : deux consonnes  de même sonorité
   ne peuvent se  suivre, qu’elles soient séparées par aucune,  une ou plusieurs
   voyelles.  Ainsi, les  termes  {{{phon(qʊn)}}} ou  {{{phon(nɔsq)}}} sont  des
   termes valides selon cette règle, mais *{{{phon(t͡ʃɔq)}}} ne l’est pas. Ainsi,
   le terme <coq> se prononcera {{{phon(t͡ʃɔħ)}}}.
